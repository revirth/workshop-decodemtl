class Enemy extends GameObject implements IMovable {
  // root: HTMLElement;
  spot: number;
  speed: number;
  mvLeft: boolean;
  ...
  constructor(root: HTMLElement, spot: number, speed: number, mvLeft: boolean) {
    super();
    this.root = root;
    this.spot = spot;
    this.speed = speed;
    ...
    this.domElement = document.createElement("img") as HTMLImageElement;
